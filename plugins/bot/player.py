...
async def not_chat(_, m: Message):
    buttons = [
            [
                InlineKeyboardButton("CHANNEL", url="https://t.me/E125E"),
                InlineKeyboardButton("SUPPORT", url="https://t.me/C125C"),
            ],
            [
                InlineKeyboardButton("🤖 MAKE YOUR OWN BOT 🤖", url="https://t.me/C125C"),
            ]
         ]
    k=await m.reply_photo(photo="https://telegra.ph/file/de7f33754517c5d74cd17.jpg", caption="**Sorry, You Can't Use This Bot In This Group! 🤷‍♂️ But You Can Make Your Own Bot Like This From The [Source Code](https://t.me/C125C) Below 😉!**", reply_markup=InlineKeyboardMarkup(buttons))
    await mp.delete(m)
