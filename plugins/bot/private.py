...
HOME_TEXT = "👋🏻 **Hi [{}](tg://user?id={})**,\n\nI'm **صوفي ميوزك ** \nI Can Play Radio / Music / YouTube Live In Channel & Group 24x7 Nonstop. Made with ❤️ By @E125E 😉!"
HELP_TEXT = """
💡 --**Setting Up**--:
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.lower() == "replay":
        ...
        buttons = [
            ...
            [
                InlineKeyboardButton("CHANNEL", url="https://t.me/c125c"),
                InlineKeyboardButton("SUPPORT", url="https://t.me/AsmSupport"),
            ],
            [
                InlineKeyboardButton("MORE BOTS", url="https://t.me/E125E"),
                InlineKeyboardButton("SOURCE CODE", url="https://t.me/c125c"),
            ],
            [
        ...
        buttons = [
            ...
            [
                InlineKeyboardButton("MORE BOTS", url="c125c"),
                InlineKeyboardButton("SOURCE CODE", url="https://t.me/c125c"),
            ],
            [
...
async def start(client, message):
    buttons = [
            ...
            [
                InlineKeyboardButton("CHANNEL", url="https://t.me/c125c"),
                InlineKeyboardButton("SUPPORT", url="https://t.me/c125c"),
            ],
            [
                InlineKeyboardButton("MORE BOTS", url="https://t.me/e125e"),
                InlineKeyboardButton("SOURCE CODE", url="https://t.me/c125c"),
    ...
    reply_markup = InlineKeyboardMarkup(buttons)
    m=await message.reply_photo(photo="https://telegra.ph/file/de7f33754517c5d74cd17.jpg", caption=HOME_TEXT.format(message.from_user.first_name, message.from_user.id), reply_markup=reply_markup)
    await mp.delete(m)
...
async def help(client, message):
    buttons = [
            ...
            [
                InlineKeyboardButton("CHANNEL", url="https://t.me/c125c"),
                InlineKeyboardButton("SUPPORT", url="https://t.me/e125e"),
            ],
            [
                InlineKeyboardButton("MORE BOTS", url="https://t.me/c125c"),
                InlineKeyboardButton("SOURCE CODE", url="https://t.me/c125c"),
            ],
            [
                InlineKeyboardButton("BACK HOME", callback_data="home"),
    ...
    msg['help'] = await message.reply_photo(photo="https://telegra.ph/file/de7f33754517c5d74cd17.jpg", caption=HELP_TEXT, reply_markup=reply_markup)
    await mp.delete(message)
